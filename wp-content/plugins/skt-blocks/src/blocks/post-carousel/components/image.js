...
export default class PostCarouselImage extends Component {
  constructor(props) {
    super(...arguments);
  ...
  render() {
    ...
    const { imageSize, imagePosition, opacity } = attributes;
      ...
      <Fragment>
        <div
          className={classnames(
            `skt-blocks-block-post-carousel-image-${imagePosition}`
          )}
        >
            ...
            !this.getImageUrl() &&
              ...
              "selectimage" !== this.props.imgSize && (
                <Fragment>
                  <div
                    className={
                      "skt-blocks-post-grid-no-image-icon"
                    }
                  >
                  ...
                  <Placeholder
                    className={
                      "skt-blocks-post-grid-no-image-placeholder"
                    }
                  >
                    <Dashicon icon={"info"} />
                    ...
                    <div className="skt-blocks-post-grid-image-help">
                      <a
                        target="_blank"
                        ...
                        href="https://github.com/studiopress/skt-blocks/wiki/Post-Grid-Block#featured-image-sizes"
                      >
                        {__("Learn more ", "skt-blocks")}
                        <span>&rarr;</span>
                      </a>
                    </div>
                  </Placeholder>
