(function () {
  ...
  function renderLightboxModal(lightboxIndex) {
    ...
    wrapper.setAttribute("class", "skt-blocks-lightbox");

    const wrapperBackground = document.createElement("div");
    wrapperBackground.setAttribute(
      "class",
      "skt-blocks-lightbox__background"
    );

    const modalHeading = document.createElement("div");
    modalHeading.setAttribute(
      "class",
      "skt-blocks-lightbox__heading"
    );

    const close = document.createElement("button");
    close.setAttribute(
      "class",
      "skt-blocks-lightbox__close"
    );

    const counter = document.createElement("span");
    counter.setAttribute(
      "class",
      "skt-blocks-lightbox__count"
    );

    const imageContainer = document.createElement("div");
    imageContainer.setAttribute(
      "class",
      "skt-blocks-lightbox__image"
    );
