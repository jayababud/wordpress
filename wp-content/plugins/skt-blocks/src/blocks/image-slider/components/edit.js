    ...
    return (
      <Fragment>
        ...
        >
          ...
          <Style>
            {`
              .wp-block-skt-blocks-image-slider .block-id-${counterId} .flickity-button .flickity-button-icon {
                  fill: ${iconColor};
              }
              .wp-block-skt-blocks-image-slider .block-id-${counterId} .flickity-button {
          ...
          {!!customWidth && (
            <Style>
              {`
              .wp-block-skt-blocks-image-slider .block-id-${counterId} .has-carousel-lrg .skt-blocks-gallery--item{
                  width: ${width}px;
              }
              `}
            </Style>
        ...
        {(!RichText.isEmpty(primaryCaption) || isSelected) && (
          <RichText
            ...
            className="skt-blocks-gallery--caption skt-blocks-gallery--primary-caption"
