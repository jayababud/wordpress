	...
	render() {
		...
		if( image_arr && typeof image_arr !== "undefined"){
			...
			if( url_check !== "" ){
				...
				return (
					<div className ="skt-blocks-tm__image-content" key={"tm_img-wrap-"+index_value}>
						<div className="skt-blocks-tm__image" key={"tm_img-"+index_value}>
							<img
								className ="skt-blocks-tm-img-src"
								src = { url }
								alt = { image.alt }
							/>
						</div>
