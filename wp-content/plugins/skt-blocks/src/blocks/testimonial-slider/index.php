 ...
 */
function skt_blocks_testimonial_carousel_add_frontend_assets( $attributes ) {
    if ( has_block( 'skt-blocks/testimonial-slider' ) ) {
        wp_enqueue_script(
            'test-slick-js',
...
add_action( 'wp_enqueue_scripts', 'skt_blocks_testimonial_carousel_add_frontend_assets' );
add_action( 'the_post', 'skt_blocks_testimonial_carousel_add_frontend_assets' );
...
function get_responsive_testimonial_js( $attr, $id ) { 			// @codingStandardsIgnoreStart.
    ...
    $selector =	'.responsive-testimonial-slick-carousel.skt-blocks-block-'.$id;
