    ...
    return (
      ...
      >
        {isSelected && (
          <Fragment>
            {supportsMoving && (
              <div className="components-skt-blocks-gallery-item__move-menu">
                <IconButton
                  icon={verticalMoving ? "arrow-up" : "arrow-left"}
                  onClick={!isFirstItem && onMoveBackward}
                  className="skt-blocks-gallery-item__button"
                  label={__(
                    "Move image backward",
                    "skt-blocks"
                  )}
            ...
            <div className="components-skt-blocks-gallery-item__remove-menu">
              <IconButton
                icon="no-alt"
                onClick={onRemove}
                className="skt-blocks-gallery-item__button"
            ...
            {linkTo === "custom" && (
              <form
                className="components-skt-blocks-gallery-item__image-link"
        ...
        captions ? (
          <RichText
            tagName="figcaption"
            placeholder={__("Write caption…", "skt-blocks")}
            className="skt-blocks-gallery--caption"
            style={captionStyles}
            value={caption}
